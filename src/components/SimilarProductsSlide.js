...
export default function SimilarProductsSlide(props) {
  const sliderRef = useRef(null);

  const products = [
    { title: 'Coral Rectangle Studs', imageUrl: ProductImg, category: 'Women’s Silver Collection', offerprice: '1234.00'  },
    { title: 'Coral Rectangle Studs', imageUrl: ProductImg2, category: 'Women’s Silver Collection', offerprice: '1234.00' },
    { title: 'Coral Rectangle Studs', imageUrl: ProductImg, category: 'Women’s Silver Collection', offerprice: '1234.00' },
    { title: 'Coral Rectangle Studs', imageUrl: ProductImg2, category: 'Women’s Silver Collection', offerprice: '1234.00' },
    { title: 'Coral Rectangle Studs', imageUrl: ProductImg, category: 'Women’s Silver Collection', offerprice: '1234.00' },
  ...
  return (
    <div className="container col-lg-10 col-md-11 col-12 product-card-design py-5" style={{overflowX:'hidden'}}>
      <h2 className="text-center" style={{ marginBottom: '40px', textTransform:'uppercase', fontWeight:'600' }}>{props.title}</h2>
      <style>
        {`
        .slick-arrow {
