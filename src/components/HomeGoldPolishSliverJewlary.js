...
export default function HomeGoldPolishSliverJewlary() {
...
<div className='mt-5'>
      ...
      <h2 className='mb-4 mt-4' style={{fontWeight: '500', textAlign:'center', color:'#2D2D2D'}}>GOLD PLOISHED SILVER JEWELLERY</h2>
