...
import ProductImg from '../assets/img/product/new-product.png';
...
export default function HomeWhatsNewOurStore() {
    ...
    <div className='mt-5'>
          ...
          <h2 className='mb-4 mt-4' style={{fontWeight: '500', textAlign:'center', color:'#2D2D2D', paddingTop:'25px'}}>WHATS NEW AT OUR STORE</h2>
