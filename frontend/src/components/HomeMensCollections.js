...
import ProductImg from '../assets/img/product/tab-3.png';
...
export default function HomeMensCollections() {
    ...
    <div className='mt-5'>
          ...
          <h2 className='mb-4 mt-4' style={{fontWeight: '500', textAlign:'center', color:'#2D2D2D'}}>MEN’S COLLECTIONS</h2>
